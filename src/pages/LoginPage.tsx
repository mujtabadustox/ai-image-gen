      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-ghibli-cream-50/95 backdrop-blur-lg rounded-2xl p-8 border-4 border-solid border-ghibli-sunset-400 shadow-2xl relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-ghibli-sunset-600">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-ghibli-coral-500 bg-ghibli-cream-100/80 border-2 border-ghibli-sunset-300 rounded focus:ring-ghibli-coral-400"
                />
                <span className="ml-2 text-sm text-ghibli-sunset-600">
                  Remember me
                </span>
              </label>
              <Link
                to="/forgot-password"
                className="text-sm text-ghibli-coral-500 hover:text-ghibli-coral-600 transition-colors"
              >
                Forgot password?
              </Link>
            </div>
